...
namespace ElectronicShop.Migrations
{
    ...
    [Migration("20220206194957_ShopMigration")]
            ...
            modelBuilder.Entity("ElectronicShop.ShopModels.Models.orderdetailsmodel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            orderdetailID = 1,
                            boughtdate = new DateTime(2022, 2, 6, 21, 49, 57, 102, DateTimeKind.Local).AddTicks(912),
                            electronicproductID = 1,
                            orderID = 2,
                            price = 1166.0,
                            quantity = 1
                        ...
                        {
                            orderdetailID = 2,
                            boughtdate = new DateTime(2022, 2, 6, 21, 49, 57, 102, DateTimeKind.Local).AddTicks(964),
                            electronicproductID = 2,
                            orderID = 2,
                            price = 1166.0,
                            quantity = 2
                        ...
                        {
                            orderdetailID = 3,
                            boughtdate = new DateTime(2022, 2, 6, 21, 49, 57, 102, DateTimeKind.Local).AddTicks(978),
                            electronicproductID = 2,
                            orderID = 1,
                            price = 1166.0,
                            quantity = 3
