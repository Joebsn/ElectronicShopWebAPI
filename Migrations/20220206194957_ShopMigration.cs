    ...
    public partial class ShopMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 20, 32, "MacbookPro", 6, 3, 750, "Apple M1", 14, 256, "Laptop" },
                    { 2, 20, 32, "MacbookPro", 6, 2, 750, "i7", 14, 256, "Laptop" },
                    { 3, 20, 32, "MacbookPro", 8, 1, 1500, "Apple M1", 14, 256, "Laptop" },
                    { 4, 20, 32, "MacbookPro", 8, 1, 750, "Apple M1", 14, 256, "Laptop" },
                    { 5, 20, 8, "MacbookPro", 8, 4, 1500, "i7", 14, 256, "Laptop" },
                    { 6, 20, 8, "MacbookPro", 8, 2, 750, "i7", 14, 256, "Laptop" },
                    { 7, 20, 8, "MacbookPro", 6, 1, 1500, "Apple M1", 14, 256, "Laptop" },
                    { 8, 20, 8, "MacbookPro", 6, 1, 750, "i7", 14, 256, "Laptop" },
                    { 9, 15, 4, "Iphone12", 4, 5, 800, "A15 Bionic", 4, 32, "Phone" },
                    { 10, 15, 4, "Iphone12", 4, 3, 1200, "A13 bionic", 4, 32, "Phone" },
                    { 11, 15, 4, "Iphone12", 4, 1, 800, "A13 bionic", 4, 32, "Phone" },
                    { 12, 15, 8, "Iphone12", 4, 1, 800, "A15 Bionic", 4, 32, "Phone" },
                    { 13, 15, 4, "Iphone12", 4, 2, 1200, "A15 Bionic", 4, 32, "Phone" },
                    { 14, 15, 8, "Iphone12", 4, 1, 1200, "A13 bionic", 4, 32, "Phone" },
                    { 15, 15, 8, "Iphone12", 4, 2, 800, "A13 bionic", 4, 32, "Phone" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 35, 9403.0, "Joe", "Joe", "msPE", 74796952 },
                    { 2, 30, 9378.0, "John", "John", "bfgR", 79941781 },
                    { 3, 25, 16839.0, "Maria", "Maria", "RTua", 71392813 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 2, 6, 21, 49, 57, 102, DateTimeKind.Local).AddTicks(912), 1, 2, 1166.0, 1 },
                    { 2, new DateTime(2022, 2, 6, 21, 49, 57, 102, DateTimeKind.Local).AddTicks(964), 2, 2, 1166.0, 2 },
                    { 3, new DateTime(2022, 2, 6, 21, 49, 57, 102, DateTimeKind.Local).AddTicks(978), 2, 1, 1166.0, 3 }
                });
